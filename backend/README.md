...
## Project Structure
    ...
    ├── mychatapplication_34903  # Django project configurations
...
1. Clone this repo and `cd mychatapplication_34903`
...
2. Clone this repo and `cd mychatapplication_34903`
